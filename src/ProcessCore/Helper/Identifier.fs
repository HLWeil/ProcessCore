...
module ProcessCore.Helper.Identifier
...
module Assay =
    ...
    let datamapFileNameFromIdentifier (identifier: string) : string =        
        checkValidCharacters (identifier)
        Path.combineMany [|Path.AssaysFolderName; identifier; Path.DatamapFileName|]
...
module Study =
    ...
    let datamapFileNameFromIdentifier (identifier: string) : string =
        checkValidCharacters (identifier)
        Path.combineMany [|Path.StudiesFolderName; identifier; Path.DatamapFileName|]
...
module Workflow =
    ...
    let cwlFileNameFromIdentifier (identifier: string) : string =
        checkValidCharacters (identifier)
        Path.combineMany [|Path.WorkflowsFolderName; identifier; Path.WorkflowCWLFileName|]
    ...
    let datamapFileNameFromIdentifier (identifier: string) : string =
        checkValidCharacters (identifier)
        Path.combineMany [|Path.WorkflowsFolderName; identifier; Path.DatamapFileName|]
...
module Run =
    ...
    let cwlFileNameFromIdentifier (identifier: string) : string =
        checkValidCharacters (identifier)
        Path.combineMany [|Path.RunsFolderName; identifier; Path.RunCWLFileName|]
    ...
    let ymlFileNameFromIdentifier (identifier: string) : string =
        checkValidCharacters (identifier)
        Path.combineMany [|Path.RunsFolderName; identifier; Path.RunYMLFileName|]
    ...
    let datamapFileNameFromIdentifier (identifier: string) : string =
        checkValidCharacters (identifier)
        Path.combineMany [|Path.RunsFolderName; identifier; Path.DatamapFileName|]
