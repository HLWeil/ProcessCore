...
- Start with the smallest mental model: datasets contain processes; processes connect sample and data nodes; property values annotate nodes, processes, recipes, and datasets.
...
- Examples use current core vocabulary: `Process`, `Recipe`, `inputs`, `outputs`, and `executesRecipe`.
