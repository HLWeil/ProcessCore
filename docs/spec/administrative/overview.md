...
Administrative properties such as `license`, `datePublished`, `dateCreated`, `dateModified`, `agents`, and `citations` are typed properties on the shared [Dataset](../process_core/Dataset.md) model.
