...
let watchDocs =
    BuildTask.create "WatchDocs" [ buildSolution ] {
        ...
        runDotNet (sprintf "fsdocs watch --output docs/output --eval --clean --properties Configuration=%s --parameters fsdocs-package-version %s" configuration versionController.StableVersionTag) "./"
    }
...
//         runDotNet (sprintf "fsdocs watch --output docs/output --eval --clean --properties Configuration=%s --parameters fsdocs-package-version %s" configuration prereleaseTag) "./"
//     }
