...
let createTag =
    BuildTask.create "CreateTag" [ clean; buildSolution; runTests; pack ] {
...
let createPrereleaseTag =
    BuildTask.create "CreatePrereleaseTag" [ setPrereleaseTag; clean; buildSolution; runTests; packPrerelease ] {
