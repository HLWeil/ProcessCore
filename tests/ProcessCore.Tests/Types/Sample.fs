module ProcessCore.Tests.Types.Sample
...
let tests = testList "Sample" [
    ...
    testCase "hashCode by name" <| fun _ ->
        let m1 = Sample("Sample1", additionalType = "Sample")
        let m2 = Sample("Sample1", additionalType = "Source")
